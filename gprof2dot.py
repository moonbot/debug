...
class DotWriter:
    ...
    def graph(self, profile, theme):
        ...
        kwargs = {}
        if self.graphLabel is not None:
            kwargs['label'] = self.graphLabel
        self.attr('graph', fontname=fontname, ranksep=0.25, nodesep=0.125, **kwargs)
...
class Main:
    ...
    def main(self):
        ...
        parser.add_option(
            '-l', '--graphLabel',
            type='string', dest='graphLabel',
            help="Label for the output graph",
            default=None)
    ...
    def write_graph(self):
        ...
        dot.graphLabel = self.options.graphLabel
